...
convention in your instruction file (`CLAUDE.md` for Claude Code, `AGENTS.md`
for Codex) — this skill tells you when and how to apply them.
...
5. **Verify live** — drive the real UI in a browser (your harness's browser
   or preview tooling; register a throwaway account if needed); check every
...
- Verified live in a real browser, including at 768px-and-below width.
