...
- ⏳ Next: Task 0.5.15 — Security hardening, Tier 0 + Tier 1 (RFC 0008). (Tasks 0.5.10/0.5.12/0.5.13/0.5.14/0.5.17 are `[future]`; 0.5.16 is `[parallel]`.) Branch from an up-to-date `main`.
