...
- ⏳ Next: Task 0.5.20 — SDK distribution & plugin isolation boundary (RFC 0023; pairs with 0.5.19). (Tasks 0.5.10/0.5.12/0.5.13/0.5.14/0.5.17 are `[future]`.) Branch from an up-to-date `main`.
