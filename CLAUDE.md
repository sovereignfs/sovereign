...
- ⏳ Next: Task 0.5.16 — Test organization (RFC 0010; `[parallel]`), then 0.5.18 (registry contribution) / 0.5.19 (stable SDK + semver). (Tasks 0.5.10/0.5.12/0.5.13/0.5.14/0.5.17 are `[future]`.) Branch from an up-to-date `main`.
