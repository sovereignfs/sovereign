...
⏳ **Next: Task 0.5.29 — Non-Docker production deployment, Phase 1 — PM2 (RFC 0026).** Health-gate in `sv serve` (poll auth health before starting runtime); `sv setup pm2` sub-command writing a canonical PM2 ecosystem config; `docs/self-hosting.md` "Non-Docker deployment (PM2)" section. Branch from up-to-date `main`.
