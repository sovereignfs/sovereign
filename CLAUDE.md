...
- **Version bumps** are part of the PR — bump the relevant `package.json`(s)
  ...
  to `1.0.0` marks the public release.** The current version is **`0.37.0`**
  ...
  and the RFC 0065 plugin catalog/access-policy work, and patch versions cover
  UI additions and production hotfixes). The
...
Current platform version: **`0.37.0`**. All roadmap tasks through slot `0.13.0` are complete; later minor bumps track post-slot tasks and patch versions are hotfixes.
