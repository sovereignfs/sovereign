...
- ⏳ Next: Task 0.5.14 — User data portability (RFC 0007), being handled by a parallel agent. Task 0.5.22 (plugin-scoped env vars) was not implemented; it can be skipped for now per the prior routing decision.
