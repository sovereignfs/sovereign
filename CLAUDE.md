...
- ⏳ Next: Task 0.5.13 — Deployment & upgrade strategy (RFC 0006, being handled by a parallel agent), then Task 0.5.14 — User data portability (RFC 0007). Task 0.5.22 (plugin-scoped env vars) was not implemented; it can be skipped for now per the prior routing decision.
