...
- ⏳ Next: Task 0.5.12 — Activity log (RFC 0005), then Task 0.5.13, Task 0.5.14, Task 0.5.17 in sequence. Task 0.5.22 (plugin-scoped env vars) was not implemented; it can be skipped for now per the prior routing decision.
