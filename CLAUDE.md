...
- **Version bumps** are part of the PR — bump the relevant `package.json`(s)
  ...
  to `1.0.0` marks the public release.** The current version is **`0.10.4`**
  (phases 0.3–0.9 tasks complete, patches .6–.10 from production hotfixes, .1–.2 from docs tasks 16.1–16.2, .3–.4 from iOS PWA stability patches). The
...
✅ **iOS PWA stability patches (.11–.12 → platform `0.10.3`–`0.10.4`, `@sovereignfs/ui` → `0.21.2`, `runtime` → `0.33.3`):**
