...
- ⏳ Next: Task 0.5.18 — Registry contribution process, then 0.5.19 (stable SDK + semver). (Tasks 0.5.10/0.5.12/0.5.13/0.5.14/0.5.17 are `[future]`.) Branch from an up-to-date `main`.
