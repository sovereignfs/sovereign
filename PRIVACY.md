...
self-hosted platform this instance runs. It states only what is true of the
platform software itself — nothing here is specific to who operates this
particular instance.

> If this instance's operator has replaced this document with their own
> (adding their identity, contact details, or additional practices), that
> version governs instead of this one. Sovereign, the open-source project,
> does not operate this instance and has no access to its data.
...
infrastructure operated by whoever runs this instance. Data may or may not
...
This document does not itself establish an age policy — that is set by
this instance's operator. If none has been published, assume no
child-specific accommodations exist.

## Changes to this document

This is the platform's default privacy document, versioned with the
platform's own source code. It changes when the platform's default behavior
changes, tracked in the project's own release history.
