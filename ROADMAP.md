...
| —       | Messages and notification detail (RFC 0048)                               | 📋     | [4.4](docs/epics/notification-center.md#-44--messages-and-notification-detail-rfc-0048)                                          |
| —       | Plugin-scoped roles and grants (RFC 0054)                                 | 📋     | [1.13](docs/epics/users-auth.md#-113--plugin-scoped-roles-and-grants-rfc-0054)                                                   |
...
| —       | Fix isolated-Postgres plugin migration-table collision                    | ✅     | [8.26](docs/epics/data-sovereignty.md#-826--fix-isolated-postgres-plugin-migration-table-collision)                              |
| —       | Wallet Postgres migration: FK ordering and `tools` compose gaps           | ✅     | [8.27](docs/epics/data-sovereignty.md#-827--wallet-postgres-migration-fk-ordering-and-tools-compose-gaps)                        |
...
| —       | Public plugin webhooks (RFC 0050)                                         | 📋     | [2.15](docs/epics/platform-shell.md#-215--public-plugin-webhooks-rfc-0050)                                                       |
| —       | Error-page digital-rights quote rotation                                  | 📋     | [2.20](docs/epics/platform-shell.md#-220--error-page-digital-rights-quote-rotation)                                              |
| —       | Plugin events and realtime channels (RFC 0045)                            | 📋     | [3.17](docs/epics/plugins-runtime.md#-317--plugin-events-and-realtime-channels-rfc-0045)                                         |
| —       | Plugin tool contracts (RFC 0047)                                          | 📋     | [3.18](docs/epics/plugins-runtime.md#-318--plugin-tool-contracts-rfc-0047)                                                       |
| —       | Plugin flow handoffs (RFC 0053)                                           | 📋     | [3.21](docs/epics/plugins-runtime.md#-321--plugin-flow-handoffs-rfc-0053)                                                        |
| —       | Email channel for broadcasts and messages (RFC 0062)                      | 📋     | [4.5](docs/epics/notification-center.md#-45--email-channel-for-broadcasts-and-messages-rfc-0062)                                 |
...
| —       | Core Assistant shell and disabled state (RFC 0063)                        | 📋     | [22.1](docs/epics/core-assistant.md#-221--core-assistant-shell-and-disabled-state-rfc-0063)                                      |
| —       | Assistant provider client and fake-provider tests (RFC 0063)              | 📋     | [22.2](docs/epics/core-assistant.md#-222--assistant-provider-client-and-fake-provider-tests-rfc-0063)                            |
| —       | Optional local inference sidecar (RFC 0063)                               | 📋     | [22.3](docs/epics/core-assistant.md#-223--optional-local-inference-sidecar-rfc-0063)                                             |
| —       | Platform-owned assistant tools and confirmation flow (RFC 0063)           | 📋     | [22.4](docs/epics/core-assistant.md#-224--platform-owned-assistant-tools-and-confirmation-flow-rfc-0063)                         |
| —       | Assistant history, preferences, and extension review (RFC 0063)           | 📋     | [22.5](docs/epics/core-assistant.md#-225--assistant-history-preferences-and-extension-review-rfc-0063)                           |
| —       | Middleware decomposition                                                  | 📋     | [2.17](docs/epics/platform-shell.md#-217--middleware-decomposition)                                                              |
