...
| Version | Task                                                            | Status | Epic task                                                                                               |
| ------- | --------------------------------------------------------------- | ------ | ------------------------------------------------------------------------------------------------------- |
| 0.4.1   | Console plugin scaffold                                         | ✅     | [13.1](docs/epics/plugin-console.md#-131--console-plugin-scaffold)                                      |
| 0.4.2   | Console: user management                                        | ✅     | [13.2](docs/epics/plugin-console.md#-132--console-user-management)                                      |
| 0.4.3   | Console: plugin management                                      | ✅     | [13.3](docs/epics/plugin-console.md#-133--console-plugin-management)                                    |
| 0.4.4   | Console: tenant settings, system health, and root plugin config | ✅     | [13.4](docs/epics/plugin-console.md#-134--console-tenant-settings-system-health-and-root-plugin-config) |
| 0.4.5   | Launcher plugin                                                 | ✅     | [15.1](docs/epics/plugin-launcher.md#-151--launcher-plugin)                                             |
| 0.4.6   | Account plugin                                                  | ✅     | [14.1](docs/epics/plugin-accounts.md#-141--account-plugin)                                              |
...
| Version | Task                                                       | Status | Epic task                                                                                 |
| ------- | ---------------------------------------------------------- | ------ | ----------------------------------------------------------------------------------------- |
| 0.5.0   | `scripts/install-plugins.ts` — plugin install script       | ✅     | [3.3](docs/epics/plugins-runtime.md#-33--scriptsinstall-pluginsts--plugin-install-script) |
| 0.5.1   | PWA configuration                                          | ✅     | [2.24](docs/epics/platform-shell.md#-224--pwa-configuration)                              |
| 0.5.2   | Production Docker image                                    | ✅     | [0.7](docs/epics/infrastructure.md#-07--production-docker-image)                          |
| 0.5.3   | Postgres validation                                        | ✅     | [0.8](docs/epics/infrastructure.md#-08--postgres-validation)                              |
| 0.5.4   | `sv` CLI — core commands                                   | ✅     | [3.4](docs/epics/plugins-runtime.md#-34--sv-cli--core-commands)                           |
| 0.5.5   | SDK implementations (db and platform)                      | ✅     | [2.3](docs/epics/platform-shell.md#-23--sdk-implementations-db-and-platform)              |
| 0.5.6   | Local session verification in middleware (AUTH-05)         | ✅     | [1.2](docs/epics/users-auth.md#-12--local-session-verification-in-middleware-auth-05)     |
| 0.5.7   | Core technical documentation                               | ✅     | [16.5](docs/epics/docs.md#-165--core-technical-documentation)                             |
| 0.5.8   | CI pipeline                                                | ✅     | [0.9](docs/epics/infrastructure.md#-09--ci-pipeline)                                      |
| 0.5.9   | Public `/api` namespace delegation                         | ✅     | [2.4](docs/epics/platform-shell.md#-24--public-api-namespace-delegation)                  |
| 0.5.10  | Overlay shell mode                                         | ✅     | [2.5](docs/epics/platform-shell.md#-25--overlay-shell-mode)                               |
| 0.5.11  | Cross-plugin data sharing (consent-gated)                  | ✅     | [2.6](docs/epics/platform-shell.md#-26--cross-plugin-data-sharing-consent-gated)          |
| 0.5.12  | Logout / self sign-out                                     | ✅     | [1.3](docs/epics/users-auth.md#-13--logout--self-sign-out)                                |
| 0.5.13  | Activity log (RFC 0005)                                    | ✅     | [5.1](docs/epics/activity-logs.md#-51--activity-log-rfc-0005)                             |
| 0.5.14  | Deployment & upgrade strategy (RFC 0006)                   | ✅     | [8.1](docs/epics/data-sovereignty.md#-81--deployment--upgrade-strategy-rfc-0006)          |
| 0.5.15  | User data portability (RFC 0007)                           | ✅     | [8.2](docs/epics/data-sovereignty.md#-82--user-data-portability-rfc-0007)                 |
| 0.5.16  | Security hardening, Tier 0 + Tier 1 (RFC 0008)             | ✅     | [2.7](docs/epics/platform-shell.md#-27--security-hardening-tier-0--tier-1)                |
| 0.5.17  | Test organization (RFC 0010)                               | ✅     | [3.5](docs/epics/plugins-runtime.md#-35--test-organization)                               |
| 0.5.18  | Icon system (RFC 0011)                                     | ✅     | [3.6](docs/epics/plugins-runtime.md#-36--icon-system)                                     |
| 0.5.19  | Registry contribution process                              | ✅     | [3.7](docs/epics/plugins-runtime.md#-37--registry-contribution-process)                   |
| 0.5.20  | Stable SDK and semver commitment                           | ✅     | [3.8](docs/epics/plugins-runtime.md#-38--stable-sdk-and-semver-commitment)                |
| 0.5.21  | SDK distribution & plugin isolation boundary (RFC 0023)    | ✅     | [3.9](docs/epics/plugins-runtime.md#-39--sdk-distribution--plugin-isolation-boundary)     |
| 0.5.22  | Plugin compatibility & versioning (RFC 0024)               | ✅     | [3.10](docs/epics/plugins-runtime.md#-310--plugin-compatibility--versioning)              |
| 0.5.23  | Plugin-scoped environment variables (RFC 0018)             | ✅     | [3.11](docs/epics/plugins-runtime.md#-311--plugin-scoped-environment-variables)           |
| 0.5.24  | Test setup & seeding (RFC 0019)                            | ✅     | [2.8](docs/epics/platform-shell.md#-28--test-setup--seeding)                              |
| 0.5.25  | Minimal shell mode (RFC 0014)                              | ✅     | [2.9](docs/epics/platform-shell.md#-29--minimal-shell-mode)                               |
| 0.5.26  | Mobile responsiveness & PWA hardening (RFC 0013)           | ✅     | [2.10](docs/epics/platform-shell.md#-210--mobile-responsiveness--pwa-hardening)           |
| 0.5.27  | Passkeys & TOTP MFA (RFC 0012)                             | ✅     | [1.4](docs/epics/users-auth.md#-14--passkeys--totp-mfa-rfc-0012)                          |
| 0.5.28  | Plugin starter template & example plugins (RFC 0017)       | ✅     | [3.12](docs/epics/plugins-runtime.md#-312--plugin-starter-template--example-plugins)      |
| 0.5.29  | Accessibility audit & a11y contract (RFC 0025)             | ✅     | [10.1](docs/epics/accessibility.md#-101--accessibility-audit--a11y-contract-rfc-0025)     |
| 0.5.30  | Non-Docker production deployment, Phase 1 — PM2 (RFC 0026) | ✅     | [0.11](docs/epics/infrastructure.md#-011--non-docker-production-deployment-phase-1--pm2)  |
| 0.5.31  | Offline connectivity banner (PWA shell)                    | ✅     | [2.11](docs/epics/platform-shell.md#-211--offline-connectivity-banner)                    |
...
| Version | Task                                     | Status | Epic task                                                                  |
| ------- | ---------------------------------------- | ------ | -------------------------------------------------------------------------- |
| 0.6.0   | Platform roles & capabilities (RFC 0021) | ✅     | [1.5](docs/epics/users-auth.md#-15--platform-roles--capabilities-rfc-0021) |
| 0.6.1   | Plugin-declared capabilities (RFC 0022)  | ✅     | [1.6](docs/epics/users-auth.md#-16--plugin-declared-capabilities-rfc-0022) |
...
| Version | Task                              | Status | Epic task                                                            |
| ------- | --------------------------------- | ------ | -------------------------------------------------------------------- |
| 0.7.0   | Notification Center (RFC 0015)    | ✅     | [4.1](docs/epics/notification-center.md#-41--notification-center)    |
| 0.7.1   | Web Push notifications (RFC 0016) | ✅     | [4.2](docs/epics/notification-center.md#-42--web-push-notifications) |
...
| Version | Task                                                            | Status | Epic task                                                                                          |
| ------- | --------------------------------------------------------------- | ------ | -------------------------------------------------------------------------------------------------- |
| 0.8.0   | Plugin monetization (RFC 0003)                                  | ✅     | [7.1](docs/epics/monetization.md#-71--plugin-monetization-rfc-0003)                                |
| 0.8.1   | Per-plugin database (RFC 0004)                                  | ✅     | [3.13](docs/epics/plugins-runtime.md#-313--per-plugin-database)                                    |
| 0.8.2   | E2E golden-path test suite (Playwright)                         | ✅     | [0.12](docs/epics/infrastructure.md#-012--e2e-golden-path-test-suite)                              |
| 0.8.3   | Production dev-mode & diagnostics (RFC 0020)                    | ✅     | [2.12](docs/epics/platform-shell.md#-212--production-dev-mode--diagnostics)                        |
| 0.8.4   | White-labeling, Phase 1 — Brand DB + shell injection (RFC 0027) | ✅     | [9.6](docs/epics/design-system.md#-96--white-labeling-phase-1--brand-db--shell-injection-rfc-0027) |
| 0.8.5   | Storybook for the design system and app shell                   | ✅     | [9.7](docs/epics/design-system.md#-97--storybook-for-the-design-system-and-app-shell)              |

---

#### Phase v0.9+ — Pre-release Hardening

For completed tasks promoted from the backlog, `Version` records the root platform version when
the implementation commit explicitly changed it. `—` means the task is complete but no
unambiguous root version was recorded; it does not mean the task is still unscheduled.

| Version | Task                                                                                                                                    | Status | Epic task                                                                                                                                                                                      |
| ------- | --------------------------------------------------------------------------------------------------------------------------------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.9.0   | Instance identity rename (RFC 0032)                                                                                                     | ✅     | [9.8](docs/epics/design-system.md#-98--instance-identity-rename-rfc-0032)                                                                                                                      |
| 0.9.1   | User data deletion (RFC 0033)                                                                                                           | ✅     | [1.7](docs/epics/users-auth.md#-17--user-data-deletion-rfc-0033)                                                                                                                               |
| 0.9.2   | Notification Center: pluggable pub/sub transport (RFC 0034)                                                                             | ✅     | [4.3](docs/epics/notification-center.md#-43--notification-center-pluggable-pubsub-transport)                                                                                                   |
| 0.9.3   | Sidebar customization — plugin ordering and visibility                                                                                  | ✅     | [2.13](docs/epics/platform-shell.md#-213--sidebar-customization--plugin-ordering-and-visibility)                                                                                               |
| 0.9.4   | Email-bound invite flow                                                                                                                 | ✅     | [1.10](docs/epics/users-auth.md#-110--email-bound-invite-flow)                                                                                                                                 |
| 0.10.0  | Test-user flag on seeded accounts                                                                                                       | ✅     | [1.11](docs/epics/users-auth.md#-111--test-user-flag-on-seeded-accounts)                                                                                                                       |
| 0.10.1  | VitePress docs site scaffold (RFC 0037)                                                                                                 | ✅     | [16.1](docs/epics/docs.md#-161--appsdocs--vitepress-workspace-scaffold)                                                                                                                        |
| 0.10.2  | Landing home page (RFC 0037)                                                                                                            | ✅     | [16.2](docs/epics/docs.md#-162--docsindexmd--landing-home-page)                                                                                                                                |
| —       | Design system component gaps — plugin developer readiness                                                                               | ✅     | [9.11](docs/epics/design-system.md#-911--design-system-component-gaps--plugin-developer-readiness)                                                                                             |
| —       | Operator fork model & upstream sync (RFC 0028)                                                                                          | ✅     | [3.14](docs/epics/plugins-runtime.md#-314--operator-fork-model--upstream-sync)                                                                                                                 |
| —       | Current-state testing documentation cleanup                                                                                             | ✅     | [16.3](docs/epics/docs.md#-163--current-state-testing-documentation-cleanup)                                                                                                                   |
| —       | Middleware regression coverage                                                                                                          | ✅     | [2.16](docs/epics/platform-shell.md#-216--middleware-regression-coverage)                                                                                                                      |
| —       | Generate script regression coverage                                                                                                     | ✅     | [3.22](docs/epics/plugins-runtime.md#-322--generate-script-regression-coverage)                                                                                                                |
| 0.11.2  | Design system stabilization                                                                                                             | ✅     | [9.12](docs/epics/design-system.md#-912--design-system-stabilization)                                                                                                                          |
| —       | Overlay size variants for platform plugins                                                                                              | ✅     | [2.19](docs/epics/platform-shell.md#-219--overlay-size-variants-for-platform-plugins)                                                                                                          |
| 0.11.3  | Per-plugin database dialect selection (RFC 0036)                                                                                        | ✅     | [3.15](docs/epics/plugins-runtime.md#-315--per-plugin-database-dialect-selection-rfc-0036)                                                                                                     |
| 0.12.0  | Extract example plugins to their own repository                                                                                         | ✅     | [12.2](docs/epics/example-plugins.md#-122--extract-example-plugins-to-their-own-repository)                                                                                                    |
| 0.13.0  | Admin disable surface for example plugins                                                                                               | ✅     | [12.3](docs/epics/example-plugins.md#-123--admin-disable-surface-for-example-plugins)                                                                                                          |
| —       | Account and security email delivery coverage (RFC 0062)                                                                                 | ✅     | [1.14](docs/epics/users-auth.md#-114--account-and-security-email-delivery-coverage-rfc-0062)                                                                                                   |
| 0.14.0  | User directory and member selection SDK (RFC 0041)                                                                                      | ✅     | [1.12](docs/epics/users-auth.md#-112--user-directory-and-member-selection-sdk-rfc-0041)                                                                                                        |
| 0.15.0  | Plugin secret vault (RFC 0043)                                                                                                          | ✅     | [8.6](docs/epics/data-sovereignty.md#-86--plugin-secret-vault-rfc-0043)                                                                                                                        |
| 0.16.0  | Plugin external connections (RFC 0049)                                                                                                  | ✅     | [3.19](docs/epics/plugins-runtime.md#-319--plugin-external-connections-rfc-0049)                                                                                                               |
| 0.18.0  | Admin-managed external provider configuration                                                                                           | ✅     | [3.27](docs/epics/plugins-runtime.md#-327--admin-managed-external-provider-configuration)                                                                                                      |
| —       | Editor workflow primitives for content plugins                                                                                          | ✅     | [9.16](docs/epics/design-system.md#-916--editor-workflow-primitives-for-content-plugins)                                                                                                       |
| 0.20.0  | Plugin file storage (RFC 0044)                                                                                                          | ✅     | [8.7](docs/epics/data-sovereignty.md#-87--plugin-file-storage-rfc-0044)                                                                                                                        |
| 0.24.0  | Client-side encryption core (RFC 0060)                                                                                                  | ✅     | [8.9](docs/epics/data-sovereignty.md#-89--client-side-encryption-core-rfc-0060)                                                                                                                |
| —       | Plugin portability hooks (RFC 0052)                                                                                                     | ✅     | [8.8](docs/epics/data-sovereignty.md#-88--plugin-portability-hooks-rfc-0052)                                                                                                                   |
| 0.26.0  | Cross-plugin references and dependency discovery (RFC 0051)                                                                             | ✅     | [3.20](docs/epics/plugins-runtime.md#-320--cross-plugin-references-and-dependency-discovery-rfc-0051)                                                                                          |
| 0.26.1  | Product-led docs site and instance directory (RFC 0067)                                                                                 | ✅     | [16.4](docs/epics/docs.md#-164--product-led-docs-site-and-instance-directory-rfc-0067)                                                                                                         |
| 0.27.0  | Email delivery failure activity logging (RFC 0062)                                                                                      | ✅     | [5.2](docs/epics/activity-logs.md#-52--email-delivery-failure-activity-logging-rfc-0062)                                                                                                       |
| 0.28.0  | Launcher grid respects saved sidebar order                                                                                              | ✅     | [2.22](docs/epics/platform-shell.md#-222--launcher-grid-respects-saved-sidebar-order)                                                                                                          |
| 0.29.0  | User groups foundation (RFC 0065)                                                                                                       | ✅     | [1.15](docs/epics/users-auth.md#-115--user-groups-foundation-rfc-0065)                                                                                                                         |
| 0.29.0  | Per-user capability grants (RFC 0070)                                                                                                   | ✅     | [1.16](docs/epics/users-auth.md#-116--per-user-capability-grants-rfc-0070)                                                                                                                     |
| 0.30.0  | Plugin access policy enforcement (RFC 0065)                                                                                             | ✅     | [2.21](docs/epics/platform-shell.md#-221--plugin-access-policy-enforcement-rfc-0065)                                                                                                           |
| 0.31.0  | Plugin catalog and install-time activation model (RFC 0065)                                                                             | ✅     | [3.28](docs/epics/plugins-runtime.md#-328--plugin-catalog-and-install-time-activation-model-rfc-0065)                                                                                          |
| 0.32.0  | Console plugin access management (RFC 0065)                                                                                             | ✅     | [13.7](docs/epics/plugin-console.md#-137--console-plugin-access-management-rfc-0065)                                                                                                           |
| 0.33.0  | Console plugin catalog browser and install-time activation (RFC 0065)                                                                   | ✅     | [13.8](docs/epics/plugin-console.md#-138--console-plugin-catalog-browser-and-install-time-activation-rfc-0065)                                                                                 |
| 0.34.0  | Invite-scoped plugin entitlement (RFC 0065)                                                                                             | ✅     | [1.17](docs/epics/users-auth.md#-117--invite-scoped-plugin-entitlement-rfc-0065)                                                                                                               |
| 0.35.0  | Plugin invite-scope grant resolution (RFC 0065)                                                                                         | ✅     | [2.23](docs/epics/platform-shell.md#-223--plugin-invite-scope-grant-resolution-rfc-0065)                                                                                                       |
| 0.36.0  | Plugin directory browsing and self-service enable/disable (RFC 0065)                                                                    | ✅     | [15.3](docs/epics/plugin-launcher.md#-153--plugin-directory-browsing-and-self-service-enabledisable-rfc-0065)                                                                                  |
...
| 0.45.0  | Offline-capable plugin routes: manifest `offline` field, `sdk.offline` cache, SW precaching, logout/login purge (RFC 0074)              | ✅     | — (ad-hoc; see `docs/rfcs/0074-offline-capable-plugins.md`)                                                                                                                                    |
...
| 0.50.1  | Shared page layout container (`PageContainer`) (RFC 0079)                                                                               | ✅     | [9.18](docs/epics/design-system.md#-918--shared-page-layout-container-pagecontainer-and-plugin-layout-convention)                                                                              |
| 0.50.1  | Overlay primitive consolidation + Plainwrite ConfirmDialog migration (RFC 0079)                                                         | ✅     | [9.19](docs/epics/design-system.md#-919--overlay-primitive-consolidation-and-plainwrite-confirmdialog-migration)                                                                               |
| 0.50.1  | Shared swipe gesture hooks + Tasks/Shopper carousel migration (RFC 0079)                                                                | ✅     | [9.20](docs/epics/design-system.md#-920--shared-swipe-gesture-hooks-and-carousel-migration-tasks-shopper)                                                                                      |
| 0.50.1  | Generic offline read+write: flattened `offline` boolean, `offline:write` permission, `sdk/offline-queue` mutation queue (RFC 0078)      | ✅     | — (ad-hoc; see `docs/rfcs/0078-offline-plugin-writes.md`)                                                                                                                                      |
| 0.51.1  | Swipeable mobile carousel primitive and responsive-layout hooks (RFC 0079)                                                              | ✅     | [9.21](docs/epics/design-system.md#-921--swipeable-mobile-carousel-primitive-and-responsive-layout-hooks)                                                                                      |
| 0.52.0  | Example plugins moved in-repo, gated by `SOVEREIGN_EXAMPLES_ENABLED`                                                                    | ✅     | [12.2](docs/epics/example-plugins.md#-122--extract-example-plugins-to-their-own-repository) (post-completion correction)                                                                       |
| 0.53.0  | Plugins version only their `manifest.json`; `package.json` pinned at `0.0.0`                                                            | ✅     | — (ad-hoc)                                                                                                                                                                                     |
| 0.54.0  | Mobile Console access moved from the account menu to the Apps drawer                                                                    | ✅     | — (ad-hoc)                                                                                                                                                                                     |
...
| 0.67.2  | One-time SQLite → libSQL data cutover tool (`sv db migrate-to-sqld`) — workstream 0009 leg 4                                            | ✅     | [8.24](docs/epics/data-sovereignty.md#-824--one-time-sqlite--libsql-data-cutover-workstream-0009-leg-4)                                                                                        |
...
| Version | Task                                                                         | Status | Epic task                                                                                                   |
| ------- | ---------------------------------------------------------------------------- | ------ | ----------------------------------------------------------------------------------------------------------- |
| 1.1.0   | Encryption at rest & field-level, Tier 2–4 (RFC 0008)                        | 📋     | [8.5](docs/epics/data-sovereignty.md#-85--encryption-at-rest--field-level-tier-24-rfc-0008)                 |
| 1.2.0   | Phase 2 payment integration (RFC 0003 Phase 2)                               | 📋     | [7.2](docs/epics/monetization.md#-72--phase-2-payment-integration-rfc-0003-phase-2)                         |
| 1.3.0   | Analytics, Phase 1 — Plugin scaffold + server-side infrastructure (RFC 0030) | 📋     | [6.1](docs/epics/analytics.md#-61--analytics-phase-1--plugin-scaffold--server-side-infrastructure-rfc-0030) |
| 1.4.0   | Analytics, Phase 2 — Client-side click tracking + heatmaps (RFC 0030)        | 📋     | [6.2](docs/epics/analytics.md#-62--analytics-phase-2--client-side-click-tracking--heatmaps-rfc-0030)        |
...
| 0.88.0  | Email template system + White-labeling Phase 2 (RFC 0031 + RFC 0027) — workstream 0013 leg 3           | ✅     | [9.9](docs/epics/design-system.md#-99--email-template-system--white-labeling-phase-2--email--auth-login-page-rfc-0031--rfc-0027)                 |
...
| —       | Device-auth unlock for `device-only` plugins (Research 0012, RFC 0093)                                 | 🚧     | [1.22](docs/epics/users-auth.md#-122--device-auth-unlock-for-device-only-plugins-research-0012-rfc-0093)                                         |
...
| —       | Messages and notification detail (RFC 0048) — workstream 0018 leg 1                                    | 📋     | [4.4](docs/epics/notification-center.md#-44--messages-and-notification-detail-rfc-0048)                                                          |
| 0.95.0  | Plugin-scoped roles and grants (RFC 0054) — workstream 0017 leg 3                                      | ✅     | [1.13](docs/epics/users-auth.md#-113--plugin-scoped-roles-and-grants-rfc-0054)                                                                   |
| —       | Encrypted operator backup bundle (RFC 0064)                                                            | 📋     | [8.10](docs/epics/data-sovereignty.md#-810--encrypted-operator-backup-bundle-rfc-0064)                                                           |
| —       | Git-backed backup remote (RFC 0064)                                                                    | 📋     | [8.11](docs/epics/data-sovereignty.md#-811--git-backed-backup-remote-rfc-0064)                                                                   |
| —       | Backup retention, deletion, and scoped restore guards (RFC 0064)                                       | 📋     | [8.12](docs/epics/data-sovereignty.md#-812--backup-retention-deletion-and-scoped-restore-guards-rfc-0064)                                        |
| —       | Backup job infrastructure & signed download delivery (RFC 0084)                                        | 📋     | [8.16](docs/epics/data-sovereignty.md#-816--backup-job-infrastructure--signed-download-delivery-rfc-0084)                                        |
...
| —       | RFC 0071 incident: pre-flight warning and remaining doc follow-ups                                     | ❌     | [8.19](docs/epics/data-sovereignty.md#-819--rfc-0071-incident-pre-flight-warning-and-remaining-doc-follow-ups--rejected)                         |
...
| 0.90.0  | `example-device-only` reference plugin — proves the `device-only` tier stack end to end (RFC 0093)     | ✅     | [12.7](docs/epics/example-plugins.md#-127--example-device-only-device-only-tier-reference-plugin-rfc-0093)                                       |
...
| 0.94.16 | Database-backed rate-limit storage for apps/auth (RFC 0086) — workstream 0017 leg 4                    | ✅     | [1.19](docs/epics/users-auth.md#-119--database-backed-rate-limit-storage-for-appsauth-rfc-0086)                                                  |
...
| —       | Plugin pre-deletion veto hook (RFC 0096, amends RFC 0033)                                              | 📋     | [1.25](docs/epics/users-auth.md#-125--plugin-pre-deletion-veto-hook-rfc-0096)                                                                    |
...
| 0.90.0  | Warden platform plugin: basic chat (RFC 0063) — workstream 0014 leg 3                                  | ✅     | [22.3](docs/epics/core-assistant.md#-223--warden-platform-plugin-basic-chat)                                                                     |
| 0.99.0  | Warden model provider registry and discovery (RFC 0063 second rewrite) — workstream 0019 leg 1         | ✅     | [22.4](docs/epics/core-assistant.md#-224--warden-model-provider-registry-and-discovery)                                                          |
| 0.100.0 | Warden persisted chat, incognito mode, and re-enable (RFC 0063 second rewrite) — workstream 0019 leg 2 | ✅     | [22.5](docs/epics/core-assistant.md#-225--warden-persisted-chat-incognito-mode-and-re-enable)                                                    |
...
| —       | Account plugin workflow coverage — workstream 0012 leg 1                                               | ✅     | [14.2](docs/epics/plugin-accounts.md#-142--account-plugin-workflow-coverage)                                                                     |
| —       | Console plugin workflow coverage — workstream 0012 leg 1                                               | ✅     | [13.5](docs/epics/plugin-console.md#-135--console-plugin-workflow-coverage)                                                                      |
| —       | Console primitive migration, Phase 2 — workstream 0012 leg 7 (scoped)                                  | ✅     | [13.6](docs/epics/plugin-console.md#-136--console-primitive-migration-phase-2)                                                                   |
| —       | Launcher plugin workflow coverage — workstream 0012 leg 1                                              | ✅     | [15.2](docs/epics/plugin-launcher.md#-152--launcher-plugin-workflow-coverage)                                                                    |
| —       | SDK boundary and runtime contract tests — workstream 0012 leg 2                                        | ✅     | [3.24](docs/epics/plugins-runtime.md#-324--sdk-boundary-and-runtime-contract-tests)                                                              |
| —       | Plugin external dependency resolution — workstream 0012 leg 8 (RFC 0057)                               | ✅     | [3.25](docs/epics/plugins-runtime.md#-325--plugin-external-dependency-resolution-rfc-0057)                                                       |
| —       | Middleware internal fetch caching review — workstream 0012 leg 6                                       | ✅     | [2.18](docs/epics/platform-shell.md#-218--middleware-internal-fetch-caching-review)                                                              |
| —       | Typecheck performance and project references — workstream 0012 leg 3                                   | ✅     | [0.14](docs/epics/infrastructure.md#-014--typecheck-performance-and-project-references)                                                          |
| —       | Operational consistency checks                                                                         | 📋     | [0.15](docs/epics/infrastructure.md#-015--operational-consistency-checks)                                                                        |
| —       | Pre-v1 stabilization gate                                                                              | 📋     | [0.16](docs/epics/infrastructure.md#-016--pre-v1-stabilization-gate)                                                                             |
| —       | Sovereign Wallet scaffold (RFC 0061)                                                                   | 📋     | [21.1](docs/epics/sovereign-wallet.md#-211--sovereign-wallet-scaffold-rfc-0061)                                                                  |
| —       | Sovereign Wallet loyalty card storage and QR/barcode rendering                                         | 📋     | [21.2](docs/epics/sovereign-wallet.md#-212--loyalty-card-storage-and-qrbarcode-rendering)                                                        |
| —       | Sovereign Wallet encrypted document snapshots                                                          | 📋     | [21.3](docs/epics/sovereign-wallet.md#-213--encrypted-document-snapshots)                                                                        |
| —       | Sovereign Wallet portability and deletion hooks                                                        | 📋     | [21.4](docs/epics/sovereign-wallet.md#-214--wallet-portability-and-deletion-hooks)                                                               |
| —       | Chat protocol selection and Veilid feasibility spike (RFC 0066)                                        | 📋     | [23.1](docs/epics/p2p-chat.md#-231--protocol-selection-and-veilid-feasibility-spike-rfc-0066)                                                    |
| —       | Chat companion app and deployment scaffold (RFC 0066)                                                  | 📋     | [23.2](docs/epics/p2p-chat.md#-232--chat-companion-app-and-deployment-scaffold)                                                                  |
| —       | Sovereign Chat Launch Profile and cookie boundary (RFC 0066)                                           | 📋     | [23.3](docs/epics/p2p-chat.md#-233--sovereign-chat-launch-profile-and-cookie-boundary)                                                           |
| —       | Chat identity, addresses, and instance discovery (RFC 0066)                                            | 📋     | [23.4](docs/epics/p2p-chat.md#-234--chat-identity-addresses-and-instance-discovery)                                                              |
| —       | Chat device enrollment, recovery, and revocation (RFC 0066)                                            | 📋     | [23.5](docs/epics/p2p-chat.md#-235--device-enrollment-recovery-and-revocation)                                                                   |
| —       | Veilid transport adapter and signed route discovery (RFC 0066)                                         | 📋     | [23.6](docs/epics/p2p-chat.md#-236--veilid-transport-adapter-and-signed-route-discovery)                                                         |
| —       | One-to-one E2EE messaging MVP (RFC 0066)                                                               | 📋     | [23.7](docs/epics/p2p-chat.md#-237--one-to-one-e2ee-messaging-mvp)                                                                               |
| —       | Encrypted offline delivery, attachments, and notifications (RFC 0066)                                  | 📋     | [23.8](docs/epics/p2p-chat.md#-238--encrypted-offline-delivery-attachments-and-notifications)                                                    |
| —       | Chat same-instance hardening and deletion (RFC 0066)                                                   | 📋     | [23.9](docs/epics/p2p-chat.md#-239--same-instance-release-hardening-portability-and-deletion)                                                    |
...
| 0.7.0   | Desktop: `biometrics.confirm` capability (macOS Touch ID; Windows Hello unverified) (RFC 0083) | ✅     | [17.10](docs/epics/desktop.md#-1710--biometricsconfirm-capability-macos-touch-id-windows-hello-written-unverified) |
...
| —       | Mobile background capability planning (RFC 0058) — workstream 0016  | 📋     | [20.9](docs/epics/mobile.md#-209--background-capability-planning)                                      |
