        ...
        <form className={styles.form} onSubmit={onSubmit}>
          ...
          <div className={styles.field}>
            <div className={styles.passwordHeader}>
              ...
              {/* forgot-password only lives on the runtime now — cross-origin link, not a same-origin route here */}
              <Link href={`${runtimeUrl}/forgot-password`} className={styles.forgotLink}>
                Forgot password?
              </Link>
            </div>
            <Input
