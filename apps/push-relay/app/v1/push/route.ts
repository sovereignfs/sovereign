 ...
 * otherwise capable of accessing the plaintext content — see RFC 0085's
 ...
 * RFC 0085's `{deviceToken, platform, encryptedPayload, instanceKey}`
 * contract.
 */
  ...
  return NextResponse.json(
    {
      ...
      message: 'Push relay is not yet implemented — see RFC 0085, workstream 0005 leg 2.',
    },
    { status: 501 },
  );
}
