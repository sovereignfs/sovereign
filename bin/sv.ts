...
// `backup`/`restore` live in ./backup-restore.ts (epic task 8.16) — shared
// with the minimal `sv-backup-cli.ts` entrypoint bundled into the
// production `runner` Docker image. Imported at the top of this file.
