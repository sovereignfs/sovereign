...
| 16  | [Docs Site & Landing Page](docs.md)           | ✅ Complete    | Public docs site + landing page at sovereignfs.github.io — content lives here, VitePress build moved to `sovereignfs/sovereignfs` |
