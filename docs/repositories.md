...
| [`sovereignfs/sovereign-mobile`](https://github.com/sovereignfs/sovereign-mobile)   | Not yet created | Capacitor shell for iOS and Android, published to the App Store and Play Store, plus a device-bridge layer (RFC 0083) for `sdk.device.*`. Code created by epic task 20.1; tracked as [workstream 0002](workstreams/0002-native-mobile-app-release.md). Planning docs (`CONCEPT.md`, `ROADMAP.md`, `AGENTS.md`, ADRs) already exist in the local checkout as of 2026-07-31, ahead of the GitHub repo and any code. |
