...
| [0013](0013-layered-database-encryption-strategy.md)      | Layered database encryption strategy (wire, app-level, zero-knowledge) | Decided        | [RFC 0092](../rfcs/0092-app-level-field-encryption.md) (Draft), epic tasks 8.31–8.34, [workstream 0011](../workstreams/0011-app-level-field-encryption.md); RFC 0060 already covers Layer 3                       |
