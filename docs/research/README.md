...
| [0015](0015-harness-engine-benchmark.md)                  | `apps/harness` engine: llama.cpp vs. Ollama benchmark                            | Decided        | llama.cpp server selected — see [RFC 0063](../rfcs/0063-core-assistant-jarvis.md); governs epic task 22.2 (workstream 0014 leg 2)                                                                                 |
