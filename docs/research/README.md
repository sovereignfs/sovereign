...
| [0003](0003-horizontal-scaling-strategy.md)               | Horizontal scaling strategy (DB, storage, orchestration)                         | Exploratory    | DB: [RFC 0091](../rfcs/0091-libsql-sqld-driver.md) (Implemented). File storage: NFS implemented directly (research-as-design exception, no RFC); MinIO/orchestration still pending                                |
...
| [0015](0015-harness-engine-benchmark.md)                  | `apps/harness` engine: llama.cpp vs. Ollama benchmark                            | Decided        | llama.cpp server selected — see [RFC 0063](../rfcs/0063-core-assistant-warden.md); governs epic task 22.2 (workstream 0014 leg 2)                                                                                 |
| [0016](0016-fediverse-activitypub-integration.md)         | Fediverse integration and ActivityPub feasibility                                | Exploratory    | Pending RFCs for a background SDK execution context, a remote media proxy, and a fediverse client plugin; native ActivityPub (Tier B) deferred behind RFC 0046 Phase 2                                            |
| [0017](0017-sqld-backup-and-restore.md)                   | SQLite (sqld) instance backup and restore                                        | Exploratory    | Pending RFC amending RFC 0084's "existing CLI, unchanged archive logic" assumption; blocks RFC 0084's worker from working for the default dialect until it lands                                                  |
| [0018](0018-design-system-level-theming-neobrutalism.md)  | Alternate visual themes at the design-system level (neobrutalism worked example) | Decided        | [RFC 0094](../rfcs/0094-design-system-theme-presets.md) (design-system theme presets), [RFC 0095](../rfcs/0095-instance-theme-preset-selection.md) (instance-level selection)                                     |
| [0019](0019-google-workspace-import.md)                   | Importing content from Google Workspace (Docs, Sheets)                           | Exploratory    | Pending RFC — needs a concrete consuming plugin/destination format and confirmation of Google's current OAuth verification policy first                                                                           |
| [0020](0020-plugin-deletion-veto-hook.md)                 | A pre-deletion veto/check hook extending RFC 0033                                | Decided        | Pending RFC amending [RFC 0033](../rfcs/0033-user-data-deletion.md) — admin-override, fail-open/closed, and registry-timing questions resolved; RFC not yet drafted                                               |
