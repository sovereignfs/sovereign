...
| [0020](0020-plugin-deletion-veto-hook.md)                 | A pre-deletion veto/check hook extending RFC 0033                                | Exploratory    | Pending RFC amending [RFC 0033](../rfcs/0033-user-data-deletion.md) — needs admin-override, fail-open/closed, and registry-timing questions resolved first                                                        |
