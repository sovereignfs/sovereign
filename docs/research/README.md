...
| [0013](0013-layered-database-encryption-strategy.md)      | Layered database encryption strategy (wire, app-level, zero-knowledge) | Decided        | Pending RFC extending RFC 0008 Task 8.5 (`sdk.crypto.encryptField()`, KEK→DEK hierarchy, sensitivity taxonomy); RFC 0060 already covers Layer 3                                                                   |
