...
| Version | Task                                                                                                  | Status | Epic task                                                                                                                   |
| ------- | ----------------------------------------------------------------------------------------------------- | ------ | --------------------------------------------------------------------------------------------------------------------------- |
| —       | **Prioritized — Plugin access & install-time activation (RFC 0065 / RFC 0070), in dependency order:** |
| —       | User groups foundation (RFC 0065)                                                                     | ✅     | [1.15](epics/users-auth.md#-115--user-groups-foundation-rfc-0065)                                                           |
| —       | Per-user capability grants (RFC 0070)                                                                 | ✅     | [1.16](epics/users-auth.md#-116--per-user-capability-grants-rfc-0070)                                                       |
| —       | Plugin access policy enforcement (RFC 0065)                                                           | ✅     | [2.21](epics/platform-shell.md#-221--plugin-access-policy-enforcement-rfc-0065)                                             |
| —       | Plugin catalog and install-time activation model (RFC 0065)                                           | ✅     | [3.28](epics/plugins-runtime.md#-328--plugin-catalog-and-install-time-activation-model-rfc-0065)                            |
| —       | Console plugin access management (RFC 0065)                                                           | ✅     | [13.7](epics/plugin-console.md#-137--console-plugin-access-management-rfc-0065)                                             |
| —       | Console plugin catalog browser and install-time activation (RFC 0065)                                 | ✅     | [13.8](epics/plugin-console.md#-138--console-plugin-catalog-browser-and-install-time-activation-rfc-0065)                   |
| —       | Invite-scoped plugin entitlement (RFC 0065)                                                           | ✅     | [1.17](epics/users-auth.md#-117--invite-scoped-plugin-entitlement-rfc-0065)                                                 |
| —       | Plugin invite-scope grant resolution (RFC 0065)                                                       | ✅     | [2.23](epics/platform-shell.md#-223--plugin-invite-scope-grant-resolution-rfc-0065)                                         |
| —       | Plugin directory browsing and self-service enable/disable (RFC 0065)                                  | ✅     | [15.3](epics/plugin-launcher.md#-153--plugin-directory-browsing-and-self-service-enabledisable-rfc-0065)                    |
| —       | Console Plugins page: unified filterable table (RFC 0065 follow-up)                                   | ✅     | [13.9](epics/plugin-console.md#-139--console-plugins-page-unified-filterable-table-rfc-0065-follow-up)                      |
...
| —       | Product-led docs site and instance directory (RFC 0067)                                               | ✅     | [16.4](epics/docs.md#-164--product-led-docs-site-and-instance-directory-rfc-0067)                                           |
