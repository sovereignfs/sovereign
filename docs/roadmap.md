...
| 0.14.0  | User directory and member selection SDK (RFC 0041)                    | ✅     | [1.12](epics/users-auth.md#-112--user-directory-and-member-selection-sdk-rfc-0041)                        |
| 0.15.0  | Plugin secret vault (RFC 0043)                                        | ✅     | [8.6](epics/data-sovereignty.md#-86--plugin-secret-vault-rfc-0043)                                        |
| 0.16.0  | Plugin external connections (RFC 0049)                                | ✅     | [3.19](epics/plugins-runtime.md#-319--plugin-external-connections-rfc-0049)                               |
| 0.18.0  | Admin-managed external provider configuration                         | ✅     | [3.27](epics/plugins-runtime.md#-327--admin-managed-external-provider-configuration)                      |
...
| 0.20.0  | Plugin file storage (RFC 0044)                                        | ✅     | [8.7](epics/data-sovereignty.md#-87--plugin-file-storage-rfc-0044)                                        |
| 0.24.0  | Client-side encryption core (RFC 0060)                                | ✅     | [8.9](epics/data-sovereignty.md#-89--client-side-encryption-core-rfc-0060)                                |
| —       | Plugin portability hooks (RFC 0052)                                   | ✅     | [8.8](epics/data-sovereignty.md#-88--plugin-portability-hooks-rfc-0052)                                   |
| 0.26.0  | Cross-plugin references and dependency discovery (RFC 0051)           | ✅     | [3.20](epics/plugins-runtime.md#-320--cross-plugin-references-and-dependency-discovery-rfc-0051)          |
| 0.26.1  | Product-led docs site and instance directory (RFC 0067)               | ✅     | [16.4](epics/docs.md#-164--product-led-docs-site-and-instance-directory-rfc-0067)                         |
| 0.27.0  | Email delivery failure activity logging (RFC 0062)                    | ✅     | [5.2](epics/activity-logs.md#-52--email-delivery-failure-activity-logging-rfc-0062)                       |
| 0.28.0  | Launcher grid respects saved sidebar order                            | ✅     | [2.22](epics/platform-shell.md#-222--launcher-grid-respects-saved-sidebar-order)                          |
| 0.29.0  | User groups foundation (RFC 0065)                                     | ✅     | [1.15](epics/users-auth.md#-115--user-groups-foundation-rfc-0065)                                         |
| 0.29.0  | Per-user capability grants (RFC 0070)                                 | ✅     | [1.16](epics/users-auth.md#-116--per-user-capability-grants-rfc-0070)                                     |
| 0.30.0  | Plugin access policy enforcement (RFC 0065)                           | ✅     | [2.21](epics/platform-shell.md#-221--plugin-access-policy-enforcement-rfc-0065)                           |
| 0.31.0  | Plugin catalog and install-time activation model (RFC 0065)           | ✅     | [3.28](epics/plugins-runtime.md#-328--plugin-catalog-and-install-time-activation-model-rfc-0065)          |
| 0.32.0  | Console plugin access management (RFC 0065)                           | ✅     | [13.7](epics/plugin-console.md#-137--console-plugin-access-management-rfc-0065)                           |
| 0.33.0  | Console plugin catalog browser and install-time activation (RFC 0065) | ✅     | [13.8](epics/plugin-console.md#-138--console-plugin-catalog-browser-and-install-time-activation-rfc-0065) |
| 0.34.0  | Invite-scoped plugin entitlement (RFC 0065)                           | ✅     | [1.17](epics/users-auth.md#-117--invite-scoped-plugin-entitlement-rfc-0065)                               |
| 0.35.0  | Plugin invite-scope grant resolution (RFC 0065)                       | ✅     | [2.23](epics/platform-shell.md#-223--plugin-invite-scope-grant-resolution-rfc-0065)                       |
| 0.36.0  | Plugin directory browsing and self-service enable/disable (RFC 0065)  | ✅     | [15.3](epics/plugin-launcher.md#-153--plugin-directory-browsing-and-self-service-enabledisable-rfc-0065)  |
| 0.37.0  | Console Plugins page: unified filterable table (RFC 0065 follow-up)   | ✅     | [13.9](epics/plugin-console.md#-139--console-plugins-page-unified-filterable-table-rfc-0065-follow-up)    |
| 0.38.0  | Private plugin repositories via access token                          | ✅     | [3.29](epics/plugins-runtime.md#-329--private-plugin-repositories-via-access-token)                       |
| 0.39.0  | Export completeness hardening (RFC 0068)                              | ✅     | [8.13](epics/data-sovereignty.md#-813--export-completeness-hardening-rfc-0068)                            |
| 0.41.0  | Public plugin page routes (RFC 0042)                                  | ✅     | [2.14](epics/platform-shell.md#-214--public-plugin-page-routes-rfc-0042)                                  |
...
| —       | Static Sovereign Guide and per-user progress (RFC 0056)                   | 📋     | [24.1](epics/plugin-guide.md#-241--static-sovereign-guide-and-per-user-progress-rfc-0056)                                   |
| —       | Role-aware and instance-aware Guide content (RFC 0056)                    | 📋     | [24.2](epics/plugin-guide.md#-242--role-aware-and-instance-aware-guide-content)                                             |
| —       | Operator-managed Guide content (RFC 0056)                                 | 📋     | [24.3](epics/plugin-guide.md#-243--operator-managed-guide-content)                                                          |
| —       | Persistent help entry and Guide update affordance (RFC 0056)              | 📋     | [24.4](epics/plugin-guide.md#-244--persistent-help-entry-and-guide-update-affordance)                                       |
