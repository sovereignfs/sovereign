...
| `SOVEREIGN_RATE_LIMIT_DISABLED`                                | no                       | —                                                   | Set to `1` (or `true`) to disable `runtime/proxy.ts`'s general per-IP rate limit — e.g. if a WAF/CDN in front of the instance already rate-limits and you don't want this layer doubling up. Unset = enabled (the default; this is a security control, so it fails closed).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| `SOVEREIGN_AUTH_STORE_NAME`                                    | no                       | `sovereign_auth`                                    | **Test-only.** Honored solely under `NODE_ENV=test`, to point a live-store test suite (`apps/auth/src/__tests__/*.sqld.test.ts`) at a throwaway sqld namespace / Postgres schema instead of the real `sovereign_auth` store. Ignored by every deployment and by `pnpm dev` by design — never set it for an instance.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
