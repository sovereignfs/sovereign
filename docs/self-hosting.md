...
| `SOVEREIGN_BACKUP_WORKER_DISABLED`                             | no                       | —                                                   | Set to `1` (or `true`) to stop the runtime from claiming/running queued backup jobs and sweeping expired archives (RFC 0084, epic task 8.16) — a separate kill-switch from `SOVEREIGN_SCHEDULER_DISABLED`/`SOVEREIGN_JOB_WORKER_DISABLED` above. Unset = the backup worker runs.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
