...
| `SV_BACKUP_GIT_REPOSITORY`                                     | no                       | —                                                   | Git remote URL an instance-scope backup pushes an age-passphrase-encrypted, tagged orphan commit to, in addition to the direct Console download (epic task 8.17, RFC 0064). Any HTTPS or SSH remote URL. Requires `SV_BACKUP_GIT_TOKEN` too (for an HTTPS remote) before Console's "Also push to the configured Git remote" checkbox appears — either alone has no effect.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
