...
| Encryption implementation | Passphrase-based AES-GCM, not age                                                                                                                                                               | Recipient-based (age) encryption — better for multi-recipient/asymmetric cases, unnecessary complexity for a single requester downloading their own backup; resolves RFC 0064's own still-open Question #1 for this narrower scope |
