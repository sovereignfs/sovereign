...
RFC 0047 depends on RFC 0035's verification-level infrastructure) is
implemented and being rebased onto `main` — this is the workstream's last
leg; once merged, all five legs are on `main`\
**Date:** August 2026\
**Author:** kasunben\
**Goal owner:** kasunben\
