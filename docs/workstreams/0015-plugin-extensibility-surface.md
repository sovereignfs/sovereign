...
**Status:** 🔄 In progress — legs 1, 3, and 5 merged to `main` (PR #447,
#445, #445 respectively; leg 1 needed three rebase rounds chasing a fast-
moving `main` — see its own changelog entries below). Leg 2 (this PR) is
implemented and rebased onto `main` — targets `0.90.0`, not yet merged. Leg
4 is implemented on its own branch stacked on workstream 0017 and has the
same rebase-and-reconcile exercise ahead of it\
**Date:** August 2026\
**Author:** kasunben\
**Goal owner:** kasunben\
