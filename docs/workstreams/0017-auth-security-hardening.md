...
**Downstream consumer waiting on this workstream:** workstream 0015's leg 3
(Task 3.18, plugin tool contracts) cannot start until legs 1–2 here (1.8,
1.9) ship — see that workstream's Prerequisites.
