...
| [0014](0014-warden-harness-engine-phase-1.md)         | Warden, phase 1 — engine benchmark, `apps/harness` service scaffold, first-party plugin with basic chat only (no tools)                                              | ✅ Done        | 0063                                                            |
