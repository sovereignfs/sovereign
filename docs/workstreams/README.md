...
| [0019](0019-warden-byo-model-providers.md)            | Per-user bring-your-own OpenAI-compatible model providers for Warden, local engine folded in as an optional entry, plus persisted chat and an incognito toggle       | 📋 Planned                                             | 0063 (second rewrite)                                           |
