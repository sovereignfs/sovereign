...
| [0009](0009-database-dialect-and-libsql-migration.md) | Single operator-chosen DB dialect platform-wide; SQLite moves to a mandatory `sqld` container           | 📋 Planned | none yet — leg 2 authors one    |
...
Workstream 0009 is independent of the others. Its leg 2 gate produces the RFC
that leg 3 depends on — do not start leg 3 before that RFC is accepted.
