...
| [0014](0014-warden-harness-engine-phase-1.md)         | Warden, phase 1 — engine benchmark, `apps/harness` service scaffold, first-party plugin with basic chat only (no tools)                                                                                                                                                                                                        | ✅ Done (deprioritized post-ship — see changelog v0.7) | 0063                                                                |
...
| [0019](0019-warden-byo-model-providers.md)            | Per-user bring-your-own OpenAI-compatible model providers for Warden, local engine folded in as an optional entry, plus persisted chat and an incognito toggle                                                                                                                                                                 | ⏳ In Progress                                         | 0063 (second rewrite)                                               |
...
| [0024](0024-dialog-dismissal-and-composition.md)      | Fix three live-verified `Dialog`/`Drawer`/`ConfirmDialog` dismissal bugs, unify the close icon, and add an explicit header/body/footer composition API to `Dialog`                                                                                                                                                             | 📋 Planned                                             | none — bug fixes plus an additive component-API change              |
