...
| [0011](0011-app-level-field-encryption.md)            | App-level field encryption — classify in schema, enforce by operator policy, KEK→DEK, blind indexes     | 📋 Planned     | 0092 (Draft — acceptance gates leg 1)                           |
