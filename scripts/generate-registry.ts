...
const PLUGIN_JOBS_FILE = join(ROOT, 'runtime', 'generated', 'plugin-jobs.ts');
const PLUGIN_EVENTS_FILE = join(ROOT, 'runtime', 'generated', 'plugin-events.ts');
 ...
 */
async function copyPluginIcons(plugins: PluginEntry[]): Promise<void> {
...
function writePluginJobs(plugins: PluginEntry[]): void {
...
function writePluginEvents(plugins: PluginEntry[]): void {
